...
- **Service worker:** cachenaam is `crimpify-v34`. Bumpen bij elke deploy die
  bestanden wijzigt (`crimpify-v35`, enz.), anders zien bezoekers de oude versie.
...
- Versienummer op de splash (nu v0.40) bij elke release ophogen, samen met de sw-cache.
