...
- **Service worker:** cachenaam is `crimpify-v23`. Bumpen bij elke deploy die
  bestanden wijzigt (`crimpify-v24`, enz.), anders zien bezoekers de oude versie.
...
- Versienummer op de splash (nu v0.29) bij elke release ophogen, samen met de sw-cache.
