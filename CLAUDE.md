...
- **Service worker:** cachenaam is `crimpify-v50`. Bumpen bij elke deploy die
  bestanden wijzigt (`crimpify-v51`, enz.), anders zien bezoekers de oude versie.
...
- Versienummer op de splash (nu v0.55) bij elke release ophogen, samen met de sw-cache.
