...
- **Service worker:** cachenaam is `crimpify-v22`. Bumpen bij elke deploy die
  bestanden wijzigt (`crimpify-v23`, enz.), anders zien bezoekers de oude versie.
...
- Versienummer op de splash (nu v0.28) bij elke release ophogen, samen met de sw-cache.
