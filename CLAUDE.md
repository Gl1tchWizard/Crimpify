...
- **Service worker:** cachenaam is `crimpify-v51`. Bumpen bij elke deploy die
  bestanden wijzigt (`crimpify-v52`, enz.), anders zien bezoekers de oude versie.
...
- Versienummer op de splash (nu v0.56) bij elke release ophogen, samen met de sw-cache.
